...
export const packages: PricingPackage[] = [
  ...
  },
  {
    ...
    featuresKey: [
      ...
      'packages.professional.f7',
      'packages.professional.f8',
    ],
  },
  {
    id: 'enterprise',
    ...
    featuresKey: [
      ...
      'packages.enterprise.f7',
      'packages.enterprise.f8',
      'packages.enterprise.f9',
    ],
  },
]
...
export const addonCategories: AddonCategory[] = [
  {
    ...
    items: [
      { icon: '🍽️', nameKey: 'addons.gastro.reservation.name', price: 'ab 199 €', descKey: 'addons.gastro.reservation.desc' },
      { icon: '🛒', nameKey: 'addons.gastro.order.name',       price: 'ab 349 €', descKey: 'addons.gastro.order.desc' },
      { icon: '📋', nameKey: 'addons.gastro.menu.name',        price: 'ab 99 €',  descKey: 'addons.gastro.menu.desc' },
    ],
  },
  {
    id: 'ecommerce',
    ...
    items: [
      { icon: '🛍️', nameKey: 'addons.ecommerce.shopBasic.name',    price: 'ab 499 €', descKey: 'addons.ecommerce.shopBasic.desc' },
      { icon: '🛍️', nameKey: 'addons.ecommerce.shopAdvanced.name', price: 'ab 999 €', descKey: 'addons.ecommerce.shopAdvanced.desc' },
      { icon: '📦', nameKey: 'addons.ecommerce.clickcollect.name', price: 'ab 199 €', descKey: 'addons.ecommerce.clickcollect.desc' },
    ],
  },
  {
    id: 'booking',
    ...
    items: [
      { icon: '📅', nameKey: 'addons.booking.appointment.name', price: 'ab 199 €', descKey: 'addons.booking.appointment.desc' },
      { icon: '🏋️', nameKey: 'addons.booking.course.name',      price: 'ab 299 €', descKey: 'addons.booking.course.desc' },
    ],
  },
  {
    id: 'marketing',
    ...
    items: [
      { icon: '💬', nameKey: 'addons.marketing.chat.name',        price: 'ab 99 €',  descKey: 'addons.marketing.chat.desc' },
      { icon: '📧', nameKey: 'addons.marketing.newsletter.name',  price: 'ab 149 €', descKey: 'addons.marketing.newsletter.desc' },
      { icon: '⭐', nameKey: 'addons.marketing.reviews.name',     price: 'ab 129 €', descKey: 'addons.marketing.reviews.desc' },
      { icon: '📱', nameKey: 'addons.marketing.social.name',      price: 'ab 79 €',  descKey: 'addons.marketing.social.desc' },
    ],
  },
  {
    id: 'tech',
    ...
    items: [
      { icon: '🔍', nameKey: 'addons.tech.seo.name',         price: 'ab 199 €', descKey: 'addons.tech.seo.desc' },
      { icon: '📊', nameKey: 'addons.tech.analytics.name',   price: 'ab 149 €', descKey: 'addons.tech.analytics.desc' },
      { icon: '♿', nameKey: 'addons.tech.wcag.name',        price: 'ab 249 €', descKey: 'addons.tech.wcag.desc' },
      { icon: '🌐', nameKey: 'addons.tech.i18n.name',        price: 'ab 199 €', descKey: 'addons.tech.i18n.desc' },
      { icon: '🔒', nameKey: 'addons.tech.cookie.name',      price: 'ab 79 €',  descKey: 'addons.tech.cookie.desc' },
    ],
  },
  {
    id: 'maintenance',
    ...
    items: [
      ...
      { icon: '🚀', nameKey: 'addons.maintenance.performance.name', price: 'ab 59 €/Mo', descKey: 'addons.maintenance.performance.desc' },
      { icon: '📞', nameKey: 'addons.maintenance.priority.name', price: 'ab 19 €/Mo', descKey: 'addons.maintenance.priority.desc' },
    ],
  },
]
